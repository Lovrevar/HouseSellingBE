...
public final class ListingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<HouseResponse,
      HouseResponse> getUpdateListingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "updateListing",
      requestType = HouseResponse.class,
      responseType = HouseResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<HouseResponse,
      HouseResponse> getUpdateListingMethod() {
    io.grpc.MethodDescriptor<HouseResponse, HouseResponse> getUpdateListingMethod;
      ...
      synchronized (ListingServiceGrpc.class) {
        if ((getUpdateListingMethod = ListingServiceGrpc.getUpdateListingMethod) == null) {
          ListingServiceGrpc.getUpdateListingMethod = getUpdateListingMethod =
              io.grpc.MethodDescriptor.<HouseResponse, HouseResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  private static volatile io.grpc.MethodDescriptor<EmailRequest,
      ShortListingResponse> getGetListingsByEmailMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getListingsByEmail",
      requestType = EmailRequest.class,
      responseType = ShortListingResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<EmailRequest,
      ShortListingResponse> getGetListingsByEmailMethod() {
    io.grpc.MethodDescriptor<EmailRequest, ShortListingResponse> getGetListingsByEmailMethod;
      ...
      synchronized (ListingServiceGrpc.class) {
        if ((getGetListingsByEmailMethod = ListingServiceGrpc.getGetListingsByEmailMethod) == null) {
          ListingServiceGrpc.getGetListingsByEmailMethod = getGetListingsByEmailMethod =
              io.grpc.MethodDescriptor.<EmailRequest, ShortListingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getListingsByEmail"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  EmailRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ShortListingResponse.getDefaultInstance()))
  ...
  public static abstract class ListingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void updateListing(HouseResponse request,
                              io.grpc.stub.StreamObserver<HouseResponse> responseObserver) {
    ...
    /**
     */
    public void getListingsByEmail(EmailRequest request,
                                   io.grpc.stub.StreamObserver<ShortListingResponse> responseObserver) {
  ...
  public static final class ListingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ListingServiceBlockingStub> {
    ...
    /**
     */
    public HouseResponse updateListing(HouseResponse request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public java.util.Iterator<ShortListingResponse> getListingsByEmail(
  ...
  public static final class ListingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ListingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<HouseResponse> updateListing(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_UPDATE_LISTING:
          serviceImpl.updateListing((HouseResponse) request,
              (io.grpc.stub.StreamObserver<HouseResponse>) responseObserver);
          break;
        case METHODID_GET_LISTINGS_BY_EMAIL:
          serviceImpl.getListingsByEmail((EmailRequest) request,
              (io.grpc.stub.StreamObserver<ShortListingResponse>) responseObserver);
          break;
        default:
